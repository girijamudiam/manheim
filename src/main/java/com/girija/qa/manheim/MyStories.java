...
public class MyStories extends JUnitStories {
    ...
    public InjectableStepsFactory stepsFactory() {
        String path = "com.girija.qa.manheim".replaceAll("\\.", "/");
        ApplicationContext context = new SpringApplicationContextFactory(path+"/dotcom-steps.xml").createApplicationContext();
